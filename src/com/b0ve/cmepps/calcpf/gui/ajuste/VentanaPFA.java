package com.b0ve.cmepps.calcpf.gui.ajuste;
...
public class VentanaPFA extends javax.swing.JFrame {
    ...
    public VentanaPFA(Estimacion estimacion) {
        initComponents();
        labelPFNA.setText(String.format("PFNA = %d", estimacion.getPFNA()));
        labelFA.setText(String.format("FA = 0.65 + (0.01 * %d) = %.2f", estimacion.getSVA(), estimacion.getFA()));
        labelPFA.setText(String.format("PFA = %d * %.2f = %.2f", estimacion.getPFNA(), estimacion.getFA(), estimacion.getPFA()));
    }
